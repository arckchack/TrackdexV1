...
ts_code = """// Cobblemon Spawn Locations & Biome Mapping for Minecraft
...
with open('src/utils/cobblemonLocations.ts', 'w', encoding='utf-8') as f:
    f.write(ts_code)

print("Created src/utils/cobblemonLocations.ts successfully!")
